...
async function main() {
  ...
  const sponsor1 = await prisma.fiscalSponsorCandidate.upsert({
    ...
    create: {
      ...
      applicationProcess: 'Online application form at https://communitypartners.org/sponsorship, proposal summary, board review cycle.',
      estimatedReviewTime: '6–8 weeks (30–45 business days)',
      setupFee: '$500 one-time onboarding fee',
      adminPercentage: '9% of gross private revenue / 12%–15% for government grants',
      ...
      internalNotes: 'Top-tier California fiscal sponsor with proven federal grant management experience (Comprehensive Model A & limited Model C).',
      citations: {
        create: [
          {
            sourceUrl: 'https://communitypartners.org/sponsorship',
            quotedSection: 'Community Partners manages over 170 projects with active federal and state grant compliance under 9% private / 12%-15% government fee structures.',
            extractedClaim: 'Verifies active government grant administration capability and published fee schedule.',
          },
        ],
      },
    },
  ...
  const sponsor2 = await prisma.fiscalSponsorCandidate.upsert({
    ...
    create: {
      ...
      intakeStatus: 'UNKNOWN',
      intakeStatusVerifiedAt: null,
      applicationProcess: 'Quarterly review cycle via https://communityinitiatives.org, preliminary proposal, formal interview.',
      estimatedReviewTime: '45–60 days',
      setupFee: '$750 initial project setup',
      adminPercentage: '10% administrative fee / 13% for government awards',
      ...
      isFixture: true,
      lastVerifiedTimestamp: new Date(),
      internalNotes: 'Established statewide sponsor with robust audit infrastructure and verified Model A / Model C sponsorship.',
    },
  });
